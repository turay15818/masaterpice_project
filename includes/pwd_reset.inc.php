<?php
  ...
  if (!(empty($_POST['reset_pwd_email'])|| trim($_POST['reset_pwd_email'])=='')){
    try{
      $db=new PDO('mysql:host=sql210.hstn.me;dbname=mseet_31600527_turaymathic_academy;charset=utf8','mseet_31600527','Mariaum15818',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
    }
    catch(Exception $err){
