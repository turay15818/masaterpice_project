...
<nav class="navbar navbar-expand-lg navbar-light bg-dark bg-gradient">
  <div class="container">
    <a class="navbar-brand text-light text-shadow" href="//www.sourcecodester" target="_blank">TURAYMATHIC ACADEMY</a>
  </div>
</nav>
    ...
    <div class="container py-5 h-100">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-center"><b>WELCOME TO TURAYMATHIC ACADEMY COURSE REGISTRATION</b></h3>
            </div>
        </div>
        <hr>
        <div class="row">
                ...
                <table class="table table-hover table-bordered table-striped" id="authors-tbl">
                    <thead>
                        <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                            ...
                            <th class="px-1 py-1 text-center">Course Name</th>
                            <th class="px-1 py-1 text-center">Instructor Name</th>
                            <th class="px-1 py-1 text-center">Instructor Email</th>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="new-author-frm">
                            ...
                            <div class="form-group">
                                <label for="last_name" class="control-label">Instructor Name</label>
                                <input type="text" class="form-control rounded-0" id="last_name" name="last_name" required>
                            </div>
                            <div class="form-group">
                                <label for="email" class="control-label">Instructor Email</label>
                                <input type="text" class="form-control rounded-0" id="email" name="email" required>
                            </div>
                            <div class="form-group">
                                <label for="birthdate" class="control-label">Start Date</label>
