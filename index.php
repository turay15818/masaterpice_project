...
<div class="site-wrap">
  ...
  <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
    ...
    <div class="container-fluid">
      <div class="d-flex align-items-center">
        <div class="site-logo mr-auto w-25"><a href="index.php">TURAYMATHIC ACADEMY</a></div>
        ...
        <div class="mx-auto text-center">
          <nav class="site-navigation position-relative text-right" role="navigation">
            <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
              ...
              <li><a href="http://turaymathicacademy.ml" class="nav-link">Paid Courses</a></li>
              <li><a href="./turaymathic_academy/index.php" class="nav-link">Admin</a></li>
              <li><a href="#teachers-section" class="nav-link">Lecturers</a></li>
            </ul>
          </nav>
        </div>
  ...
  <div class="intro-section" id="home-section">
    ...
    <div class="side-1" style="background-image: url('./jswallpaper.png');" data-stellar-background-ratio="0.5">
      <div class="container">
...
<h1 class="class-center" style="text-align: center;  color:white; font-size:65px; width:55%;">Welcome to TurayMathic E Learning Center</h1>
<div style="width:auto">
  <h3 class="class-center" style="text-align:center; color:white; width:60%;">We Provide students with access to Advanced Placement and specialized courses,
  which may not be offered at their traditional brick-and-mortar school 
  in order to promote educational equality</h3>
  </div>    
</div>
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
          <h2 class="section-title">See some of our Premium Courses</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="owl-carousel col-12 nonloop-block-14">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            <figure class="m-0">
              <img src="images/Photoshop.jpg" alt="Image" class="img-fluid">
            </figure>
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>10 Lession 5 Months</div>
              <h3><a href="http://turaymathicacademy.ml">Photoshop</a></h3>
              <p>Learn Photoshop and become a graphic designer. </p>
            </div>
            <div class="d-flex border-top stats">
              <div class="py-3 px-4"><span class="icon-users"></span> 193 students</div>
          ...
          <div class="course bg-white h-100 align-self-stretch">
            <figure class="m-0">
              <img src="./loggedin/ai.png" alt="Image" class="img-fluid">
            </figure>
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>20 Lessons 6 Months</div>
              <h3><a href="http://turaymathicacademy.ml">Introduction to Artificial Intelligence</a></h3>
              <p>Discover the Best out of AI </p>
            </div>
            <div class="d-flex border-top stats">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            <figure class="m-0">
              <img src="images/figma.png" alt="Image" class="img-fluid">
            </figure>
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>13 Lessons 12 week</div>
              <h3><a href="http://turaymathicacademy.ml">Figma</a></h3>
              <p>Become the Best UI/UX Designer </p>
            </div>
            <div class="d-flex border-top stats">
              <div class="py-3 px-4"><span class="icon-users"></span>193 students</div>
              <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>33 Lessons  19 week</div>
              <h3><a href="http://turaymathicacademy.ml">C++</a></h3>
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>6 Lessons  5 week</div>
              <h3><a href="http://turaymathicacademy.ml">JAVA</a></h3>
              <p>java is a must learn versatile language. </p>
            </div>
            <div class="d-flex border-top stats">
              <div class="py-3 px-4"><span class="icon-users"></span>523 students</div>
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$50</span>
              <div class="meta"><span class="icon-clock-o"></span>55 Lessons  37 week</div>
              <h3><a href="http://turaymathicacademy.ml">Python</a></h3>
              <p>Begin your journey in the world of AI. </p>
            </div>
            <div class="d-flex border-top stats">
              <div class="py-3 px-4"><span class="icon-users"></span>453 students</div>
      ...
      <div class="row justify-content-center">
        <div class="col-7 text-center">
          ...
          <button class="customNextBtn btn btn-primary m-1">Next</button><br>
          <a href="http://turaymathicacademy.ml" class="mybtn2"><button class="customNextBtn btn btn-primary m-1">Browse for our Premium Courses</button></a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
          ...
          <p>We aim to make studying SIMPLE, EASY and ACCESSIBLE to EVERYONE thus we collected the BEST COURSES in the world and puth them in one place.</p>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 mb-5 text-center"  data-aos="fade-up" data-aos-delay="">
          <h2 class="section-title">Meet Some of Our Instructors</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="teacher text-center">
            <img src="images/Musa-Turay.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
            <div class="py-2">
              <h3 class="text-black">Musa Turay</h3>
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
          <div class="teacher text-center">
            <img src="images/Ibrahim-Daboh.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
            <div class="py-2">
              <h3 class="text-black">Ibrahim Daboh</h3>
              <p class="position">AI Instructor</p>
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="teacher text-center">
            <img src="images/Mohamed-Turay.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
            <div class="py-2">
              <h3 class="text-black">Mohamed Turay</h3>
              <p class="position">Cyber Security Instructor</p>
              <p>Leading expert in the domain of Cyber Security, taught many students over the years.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center testimony">
          <img src="images/Miatta-Duveh.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
          <h3 class="mb-4">Miatta Duveh</h3>
          <blockquote>
            <p>&ldquo; I was struggling with my studies but it all changed when I learned about TurayMathic Academy, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
          </blockquote>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto align-self-start"  data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="p-4 rounded bg-white why-choose-us-box">
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
              ...
              <div><h3 class="m-0">We are the Best</h3></div>
            </div>

            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
              <div><h3 class="m-0">Taught over Thousand of Students</h3></div>
            </div>
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
              <div><h3 class="m-0">Best Instructor</h3></div>
            </div>
        ...
        <div class="col-lg-7 align-self-end"  data-aos="fade-left" data-aos-delay="200">
          <img src="images/whyus.png" alt="Image" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7">
          ...
          <p class="mb-5">We will be more than happy to receive your informative message.</p>
          ...
          <form method="post" action="./contact_us/index.php#contact-section" data-aos="fade" id="contact_form">
      ...
      <div class="row">
        ...
        <div class="col-md-3 ml-auto">
          ...
          <ul class="list-unstyled footer-links">
            ...
            <li><a href="#courses-section" class="nav-link">Courses</a></li>
            <li><a href="#programs-section" class="nav-link">Programs</a></li>
            <li><a href="#teachers-section" class="nav-link">Instructors</a></li>
          </ul>
        </div>
