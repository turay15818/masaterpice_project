...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section single-cover" id="home-section">
      ...
      <div class="slide-1 text-white" style="background-image: url('../../../images/banner1.webp');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Bootstrap 5 for Absolute Beginners</h1>
                  <p data-aos="fade-up" data-aos-delay="100" class="text-white">&bullet; <a href="#" class="text-white"></a></p>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>Bootstrap 5 is the newest version of Bootstrap, <br>
              which is the most popular HTML, CSS, and JavaScript framework for creating responsive, <br>
              mobile-first websites. Bootstrap 5 is completely free to download and use!</p>
            </div>
