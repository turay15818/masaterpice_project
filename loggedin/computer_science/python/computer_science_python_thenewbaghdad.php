...
<title>TURAYMATHIC ACADEMY</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Introduction to Bootstrap for Absolute Beginners</a></li>
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        ...
        <a href="actualvideocontent_thenewbaghdad.php?video=7">&#10170  Life Project Design Example 1</a><br>
      </div>
    </div>
  </div>
  <!-- Détails chapitre 2 -->
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
        ...
        <a href="actualvideocontent_thenewbaghdad.php?video=13">&#10170  Bootstrap Button Tutorial</a><br>
        <a href="actualvideocontent_thenewbaghdad.php?video=18">&#10170  Bootstrap Button Grid Tutorial</a><br>
  ...
  <div class="card">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
      <div class="card-body">
        ...
        <a href="actualvideocontent_thenewbaghdad.php?video=19">&#10170  Bootstrap Tooltip</a><br>
  ...
  <div class="card">
    ...
    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
      <div class="card-body">
        <a href="actualvideocontent_thenewbaghdad.php?video=30">&#10170  Bootstrap Snippet</a><br>
