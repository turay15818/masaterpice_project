...
<div class="java-container">
  ...
  <div class="card" >
      ...
      <div class="card-body">
        <p class="card-text">Introduction to Neteorking</p>
        <p class="card-text details" >Duration: <span style="color:tomato">5 Months</span></p> </p>
        <p class="card-text details" >Tutor : Network Direction</p>
  ...
  <div class="card" >
      ...
      <div class="card-body">
        ...
        <p class="card-text details" >Tutor : Mizko</p>
      </div>
