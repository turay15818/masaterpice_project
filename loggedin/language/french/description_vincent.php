          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Introduction to Figma</h1>
                  <p data-aos="fade-up" data-aos-delay="100" class="text-white"1> &bullet; <a href="#" class="text-white"></a></p>
                </div>
              </div>
            </div>
