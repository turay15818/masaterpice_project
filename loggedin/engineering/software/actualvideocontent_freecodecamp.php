...
<title>TurayMathic Academy</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="engineering_software_freecodecamp.php" style="color:white;">Computer Science and Software Engineering</a></li>
