          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">HTML and CSS</h1>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>This course is designed to help students get a better grasp on HTML and CSS.</p>
            </div>
          ...
          <div class="col-lg-4 pl-lg-5">
            <div class="mb-5 text-center border rounded course-instructor">
              ...
              <div class="mb-4 text-center">
                <img src="../../../images/und.jpg" alt="Image" class="w-25 rounded-circle mb-4">
                <h3 class="h5 text-black mb-4">Everything you need to know about HTML and CSS</h3>
                  <p>
